...
import {faUser, faVolumeMute} from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        <div className="host-page">
            ...
            <motion.div className="system-ui" initial={{opacity: 0, y: 100}} animate={{opacity: 1, y: 0}}>
                <Button icon={faUser} text="0" padding="0.5rem 1rem"/>
                <Button icon={faVolumeMute}padding="0.5rem 1rem"/>
            </motion.div>
        </div>
    );
}